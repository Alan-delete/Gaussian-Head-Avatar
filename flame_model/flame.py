...
# the naive way to solve the mismatch in chumpy.
# the best way is to use corresponding version of numpy, but here is to avoid possible version conflict
np.bool = np.bool_
np.int = np.int_
np.float = np.float_
...
# FLAME_FOLDER = "flame_model/assets/flame"
FLAME_FOLDER = "assets/FLAME"

FLAME_MESH_PATH = FLAME_FOLDER + "/head_template_mesh.obj"
FLAME_LMK_PATH = FLAME_FOLDER + "/landmark_embedding_with_eyes.npy"
...
FLAME_MODEL_PATH = FLAME_FOLDER + "/flame2023.pkl"  # FLAME 2023 (versions w/ jaw rotation)
FLAME_PARTS_PATH = FLAME_FOLDER + "/FLAME_masks.pkl" # FLAME Vertex Masks
