...
class GaussianHeadHairTrainer():
    ...
    def train(self, start_epoch=0, epochs=1):
        iteration = start_epoch * len(self.dataloader)
        ...
        for epoch in range(start_epoch, epochs):
            ...
            for idx, data in tqdm(enumerate(self.dataloader)):
                ...
                # Once enter dynamic training, disable static training
                ...
                elif iteration % self.recorder.show_freq == 0:
                ...
                if self.gaussianhair is not None:
                    ...
                    self.gaussianhair.generate_hair_gaussians(skip_smpl=iteration <= self.cfg.gaussianheadmodule.densify_from_iter, 
                                                            ...
                                                            poses_history = data['poses_history'][0] if iteration > static_training_util_iter and len(dataset.samples) > 1 else None, 
                ...
                if iteration > 20000:
                    decay_rate = 0.5 ** ( iteration // 20000)
